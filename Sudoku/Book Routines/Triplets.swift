                ...
                if Globals.actual[c][r] == 0  && Globals.possible[c][r].count == 3 {
                    ...
                    for cc in 0..<9 {
                        ...
                        if (cc != c) &&                     //MARK: (0)  (1)
                            ...
                            Globals.possible[cc][r].contains(String(Globals.possible[c][r].prefix(1))) &&
                ...
                if Globals.actual[c][r] == 0 && Globals.possible[c][r].count == 3 {
                    ...
                    for rr in 0..<9 {
                        if rr != r &&
                            ...
                            Globals.possible[c][r].contains(String(Globals.possible[c][rr].prefix(1))) &&
                            Globals.possible[c][r].contains(String(Globals.possible[c][rr].suffix(1))) {
