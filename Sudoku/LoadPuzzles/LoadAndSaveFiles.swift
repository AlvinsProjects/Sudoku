...
struct puzArray {
    ...
    static var SudokuFiles = [
        ...
        Puzzle(number: 14, name: "FaceB",  content: "700000000350000000289000000892500000435720000176938000517382900648195320923674518"),
...
//        Puzzle(number: 16, name: "Fig7-1", content: "921004570705209840084570209279400085546000700813705400402009708197608304058940007"),
        Puzzle(number: 16, name: "Outpu4",   content: "000000005020009000090020003730048100000360000580000400010003580004200000009780002"),
        Puzzle(number: 17, name: "Outpu7",   content: "003460020058020001020900080001000090200783000000000300009006000000000056060070210")
